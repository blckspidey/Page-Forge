      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-panel rounded-2xl p-8 border border-white/10 shadow-2xl">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-3 px-4 py-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-200 text-sm font-medium text-slate-200 mb-6 group"
          >
