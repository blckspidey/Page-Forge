 ...
 */
router.post('/merge', upload.array('files'), handleMerge);
 ...
 */
router.post('/split', upload.single('file'), handleSplit);
 ...
 */
router.post('/organize', upload.single('file'), handleOrganize);
 ...
 */
router.post('/edit', upload.single('file'), handleEdit);
